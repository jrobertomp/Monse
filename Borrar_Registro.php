...
$sql="DELETE FROM registros WHERE Id_Registro = '{$_POST["Id_Registro"]}' ";
if (!mysqli_query($con, $sql, MYSQLI_USE_RESULT))
{
die('Error: '.mysqli_error($con));
}echo "Registro borrado<br><br>";
echo "<a href='Borrar_Registro.html'>Regresar</a>";// llamamos a consultas para ver el nuevo registro
mysqli_close($con);
?>