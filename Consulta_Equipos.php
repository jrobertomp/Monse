...
$resultado=mysqli_query($con,"select*from equipos");//consultamos el contenido de la tabla de clientes
if($resultado===FALSE){
	echo"fallo";
	die(mysqli_error());//muestra el error que ocurrio
}
echo"<center><font face=`arial`>";
echo "<a href='Consulta_Equipos.php'> Actualizar tabla</a>";
echo "<h1>Consulta de la tabla Equipos</h1>";
echo "<table border='1'>
<tr>
<th>Equipo</th>
<th> Nombre</th>
...
{
	echo "<tr>";
	echo "<td align=center>".$row['Id_Numero_Equipo']."</td>";
