...
$sql="DELETE FROM equipos WHERE Id_Numero_Equipo = '{$_POST["Id_Numero_Equipo"]}' ";
if (!mysqli_query($con, $sql, MYSQLI_USE_RESULT))
{
die('Error: '.mysqli_error($con));
}echo "Registro borrado<br><br>";
echo "<a href='Borrar_Equipo.html'>Regresar</a>";// llamamos a consultas para ver el nuevo registro
mysqli_close($con);
?>