...
VALUES('$_POST[Id_Matricula]','$_POST[Nombre]','$_POST[Telefono]','$_POST[Mensualidades]')";
if (!mysqli_query($con, $sql, MYSQLI_USE_RESULT))
{
	die('Error. ' .mysqli_error($con));
}
echo "<center>";
echo "<h1>1 registro agregado</h1> <br>";
echo "<a href='Actualizar_Clientes.php'>Ver Registros</a>";
mysqli_close($con);
?>